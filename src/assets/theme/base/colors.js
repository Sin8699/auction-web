/**
 * The base colors for the Soft UI Dashboard Material-UI.
 * You can add new color using this file.
 * You can customized the colors for the entire Soft UI Dashboard Material-UI using thie file.
 */
// eslint-disable-next-line import/no-anonymous-default-export
export default {
  background: { default: '#f8f9fa' },
  text: { main: '#67748e', focus: '#67748e' },
  transparent: { main: 'transparent' },
  white: { main: '#ffffff', focus: '#ffffff' },
  black: { light: '#141414', main: '#000000', focus: '#000000' },
  primary: { main: '#cb0c9f', focus: '#ad0a87' },
  secondary: { main: '#8392ab', focus: '#96a2b8' },
  info: { main: '#17c1e8', focus: '#3acaeb' },
  success: { main: '#82d616', focus: '#95dc39' },
  warning: { main: '#fbcf33', focus: '#fcd652' },
  error: { main: '#ea0606', focus: '#c70505' },
  light: { main: '#e9ecef' },
  dark: { main: '#344767', focus: '#344767' },
  grey: {
    100: '#f8f9fa',
    200: '#e9ecef',
    300: '#dee2e6',
  ...
  socialMediaColors: {
    ...
    lingerie: { main: '#0077b5', dark: '#00669c' },
